...
3. **Follow these strict rules**:
   ...
   - **Generate the main title in the format**: `MDTUVOLKRD-<ticket-id-from-branch-name> Auto-Generated Title Based on the Change Details`
...
## [MDTUVOLKRD-<ticket-id> <Auto-Generated Title Based on the Change Details>](https://jiraeu.epam.com/browse/MDTUVOLKRD-<ticket-id>)
...
## [MDTUVOLKRD-526 Added User Authentication with JWT based on EPAM SSO](https://jiraeu.epam.com/browse/MDTUVOLKRD-526)
...
- The main title MUST follow the format: `MDTUVOLKRD-<ticket-id> Auto-Generated Title Based on the Change Details`
