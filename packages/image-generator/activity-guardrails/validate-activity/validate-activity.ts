 ...
 * @returns {ActivityValidationResult} Validation result with sanitized activity if needed
 * @internal
 */
const validateActivityValues = (activity: Activity): ActivityValidationResult => {
  const errors: string[] = [];
  const sanitized: Activity = { ...activity };
 ...
 * @internal
 */
const validateActivitySemantics = (activity: Activity): ActivityValidationResult => {
  const errors: string[] = [];
 ...
 *
 * @param {Activity} activity - Activity data to validate
 * @returns {ActivityValidationResult} Validation result with errors and optional sanitized activity
 *
 * @remarks
 ...
 */
const validateActivity = (activity: Activity): ActivityValidationResult => {
  const errors: string[] = [];
