...
describe('classify-environment', () => {
  test.each<Case>([
    [
      'virtual ride classifies as indoor training space',
      'VirtualRide',
      'indoor training space',
    ],
    [
      'virtual run classifies as indoor training space',
      'VirtualRun',
      'indoor training space',
    ],
    [
      'outdoor run classifies as outdoor training space',
      'Run',
      'outdoor training space',
    ],
    [
      'trail run classifies as outdoor training space',
      'TrailRun',
      'outdoor training space',
    ],
    [
      'cycling classifies as outdoor training space',
      'Ride',
      'outdoor training space',
    ],
    [
