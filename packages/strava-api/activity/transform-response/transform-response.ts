 ...
 * StravaActivity type used by the system. Handles field name differences (e.g.,
 ...
 * @returns {StravaActivity} Activity object in internal format with required fields (type)
 ...
 * ```
 */
const transformResponse = (apiResponse: StravaActivityApiResponse | null): StravaActivity | null => {
  if (apiResponse) {
